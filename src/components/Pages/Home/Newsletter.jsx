  ...
  return (
    <section
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-base-100 border border-base-200 rounded-2xl p-6 sm:p-8 shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            <div>
              <h3
                id="newsletter-title"
                className="text-2xl sm:text-3xl font-extrabold text-secondary">
                Stay in the loop
              </h3>
              ...
              <ul className="mt-4 text-sm space-y-2 text-base-content">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  <div className="flex gap-3">
                    ...
                    <input
                      ...
                      className="w-full input input-lg rounded-xl px-4 py-3 border-base-300 focus:outline-none focus:ring-2 focus:ring-primary/40"
                      aria-invalid={!!error}
                    ...
                    <button
                      type="submit"
                      className="inline-flex items-center gap-2 rounded-xl px-4 py-3 shadow-sm bg-secondary text-black font-semibold hover:opacity-95 disabled:opacity-60"
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <p id="nh-hint" className="text-xs text-base-content/60">
          ...
          <div className="mt-6 h-1 rounded-full w-full bg-base-200" />
        </div>
      </div>
    </section>
  );
